package be.kdg.ip2.carpoolers.backend.service.implementation;

import be.kdg.ip2.carpoolers.backend.domain.user.Authority;
import be.kdg.ip2.carpoolers.backend.domain.user.User;
import be.kdg.ip2.carpoolers.backend.domain.user.UserRideInfo;
import be.kdg.ip2.carpoolers.backend.repository.declaration.UserRepository;
...
@Transactional
@Primary
public class UserServiceImpl implements be.kdg.ip2.carpoolers.backend.service.declaration.UserService {
